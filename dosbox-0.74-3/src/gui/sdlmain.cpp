...
{	Bitu gotbpp;
	...
	switch (gotbpp)
	{	case 8:
			if (*flags & GFX_CAN_8) *flags&=~(GFX_CAN_15|GFX_CAN_16|GFX_CAN_32);			break;		case 15:
			if (*flags & GFX_CAN_15) *flags&=~(GFX_CAN_8|GFX_CAN_16|GFX_CAN_32);			break;		case 16:
			if (*flags & GFX_CAN_16) *flags&=~(GFX_CAN_8|GFX_CAN_15|GFX_CAN_32);			break;		case 24:		case 32:
			if (*flags & GFX_CAN_32) *flags&=~(GFX_CAN_8|GFX_CAN_15|GFX_CAN_16);			break;
	}
...
char ssdSetSize(Bitu width,Bitu height,Bitu flags,double scalex,double scaley, Bitu *retFlags){
	...
	switch (sdl.surface->format->BitsPerPixel) {
	case 15:
		*retFlags = GFX_CAN_15 | GFX_SCALING | GFX_HARDWARE;		break;
	case 16:
...
void Config_Add_SDL() {
	...
	Pbool = sdl_sec->Add_bool("fulldouble",Property::Changeable::Always,false);	Pbool->Set_help("Use double buffering in fullscreen. It can reduce screen flickering, but it can also result in a slow DOSBox.");
